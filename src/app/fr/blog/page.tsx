...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://secureredact.tech/fr/blog',
    languages: {
        ...
        {posts.map(post => (
          <article key={post.id} className="neo-box p-8 hover:translate-x-1 hover:translate-y-1 transition-transform bg-white relative overflow-hidden">
            ...
            <h2 className="text-3xl font-black mb-4">
              <Link href={`/fr/blog/${post.id}`} className="text-black hover:text-blue-600 transition-colors">
                {post.title}
              </Link>
            </h2>
