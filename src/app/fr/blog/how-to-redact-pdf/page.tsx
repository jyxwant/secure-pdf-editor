...
const t = resources.fr.translation;

export const metadata: Metadata = {
  title: t['blog.post1.title'],
  description: t['blog.post1.excerpt'],
  alternates: {
    canonical: 'https://secureredact.tech/fr/blog/how-to-redact-pdf',
    languages: {
...
export default function Page() {
  return (
    <div className="max-w-4xl mx-auto px-6 py-12 bg-white min-h-screen">
      <Link href="/fr/blog" className="inline-flex items-center text-gray-600 hover:text-black mb-8 font-bold group">
      ...
      <article className="prose prose-lg max-w-none prose-headings:font-black prose-headings:text-black prose-a:text-blue-600 prose-p:text-gray-700 prose-p:font-medium">
        ...
        <p>
          Pour en savoir plus sur la confidentialité des données, vous pouvez lire sur les <a href="https://gdpr.eu/what-is-gdpr/" target="_blank" rel="nofollow noreferrer">normes de conformité RGPD</a>.
        </p>
